    ...
    tours: [
        {
            ...
            places: [
                ...
                {title:"Вечный город — культурная мозаика Узбекистана", img: "https://dolorestravel.com/uploads/ModelContentRow/33/service_content-5d77a7632d18b.webp", body: "В современном историко-этнографический парке представлена история, культура и архитектура всей нашей гостеприимной и радушной страны. В одном месте вы увидите мотивы Самарканда, Бухары, Ферганы, Ташкена, Хивы. Выясните, почему здесь умышленно не стали создавать точные реплики достопримечательностей."},
            ]
        },
        {
            id: 2,
