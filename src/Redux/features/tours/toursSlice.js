...
const initialState = {
    tours: [
        ...
        },
        {
            id: 2,
            title: "Тур по Бухаре",
            body: "Бухара́ (узб. Buxoro) — один из древнейших городов Центральной Азии, административный центр Бухарской области Узбекистана; настоящий архитектурный и историко-культурный заповедник, сохранивший уникальные памятники зодчества всех исторических эпох, начиная с IX века. В развитое средневековье она была средоточием культуры, науки и мусульманской теологии всего Среднего и Ближнего Востока.",
            price: "100$",
            img: bukhara,
            img2: bukhara2
        },
