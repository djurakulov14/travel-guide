    ...
    tours: [
        {
            ...
            places: [
                {title:"Площадь Регистан", img: "https://cdn.tripster.ru/thumbs2/84e2ae84-594f-11ed-a372-deb9864510e4.800x600.jpeg", body: "Я обязательно представлю вам главную достопримечательность нашего города, состоящую из двух величественных медресе и мечети, которая восхищает своим убранством. Во внутренних двориках медресе, слушая рассказы о процессе обучения студентов, вы представите и поймете, как работала наша система образования в 15-17 веках."},
                {title:"Мавзолей Гур-Эмир", img: "https://cdn.tripster.ru/thumbs2/9dd3cdca-594e-11ed-865b-deb9864510e4.800x600.jpeg", body: "С особым удовольствием я поделюсь с вами рассказами об истории жизни Тамерлана, его военных походах и судьбе империи Тимуридов после его смерти. «Правитель мира», один из величайших полководцев в истории человечества, личность, овеянная сотнями легенд — что мы знаем о нем доподлинно и каков истинный вес его исторической роли? Обсудим на встрече!"},
                {title:"Мечеть Биби-Ханым", img: "https://cdn.tripster.ru/thumbs2/dc1839fe-594e-11ed-bfbb-ee13dcd0c4e0.800x600.jpeg", body: "Осматривая снаружи крупнейшую мечеть Средней Азии, вы узнаете об особенностях возведения памятника 14 века. Также мы поговорим о том, чем сегодня мечети отличаются по своей структуре и архитектуре."},
                {title:"Вечный город — культурная мозаика Узбекистана", img: "https://dolorestravel.com/uploads/ModelContentRow/33/service_content-5d77a7632d18b.webp", body: "В современном историко-этнографический парке представлена история, культура и архитектура всей нашей гостеприимной и радушной страны. В одном месте вы увидите мотивы Самарканда, Бухары, Ферганы, Ташкена, Хивы. Выясните, почему здесь умышленно не стали создавать точные реплики достопримечательностей. И оцените богатство тысячелетних традиций Узбекистана, заглядывая в лавки мастеров."},
            ]
        },
        {
            id: 2,
